"""
Fine-tune mBERT model with QLoRA (Quantized LoRA) technique on Urdu Multi-Domain Classification dataset
...
LEARNING_RATE = 2e-5
NUM_EPOCHS = 10
OUTPUT_DIR = "./mbert_qlora_multiclass"
...
def main():
    ...
    print("=" * 60)
    print("mBERT QLoRA Fine-tuning for Urdu Multi-class Classification (Sentiment Domain)")
    print("=" * 60)
