"""
Fine-tune mBERT model with LoRA technique on Urdu Sentiment Analysis dataset
...
LEARNING_RATE = 2e-5
NUM_EPOCHS = 10
OUTPUT_DIR = "./mbert_lora_urdu_sentiment"
...
def main():
    ...
    print("=" * 60)
    print("mBERT LoRA Fine-tuning for Urdu Sentiment Analysis")
    print("=" * 60)
