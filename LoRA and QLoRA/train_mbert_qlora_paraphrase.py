"""
Fine-tune mBERT model with QLoRA (Quantized LoRA) technique on UPPC (Urdu Paraphrase Plagiarism Corpus) dataset
...
LEARNING_RATE = 2e-5
NUM_EPOCHS = 10
OUTPUT_DIR = "./mbert_qlora_paraphrase"
...
def main():
    ...
    print("=" * 60)
    print("mBERT QLoRA Fine-tuning for Urdu Paraphrase Detection (UPPC Dataset)")
    print("=" * 60)
