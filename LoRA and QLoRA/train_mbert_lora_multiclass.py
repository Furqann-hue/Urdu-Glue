"""
Fine-tune mBERT model with LoRA technique on Urdu Multi-Domain Classification dataset
...
LEARNING_RATE = 2e-5
NUM_EPOCHS = 10
OUTPUT_DIR = "./mbert_lora_multiclass"
...
def load_urdu_multiclass_data(train_split: float = 0.8, random_state: int = 42):
    ...
    if len(unique_labels) > NUM_LABELS:
        ...
        print("   Using first {NUM_LABELS} labels")
...
def main():
    ...
    print("=" * 60)
    print("mBERT LoRA Fine-tuning for Urdu Multi-class Classification (Sentiment Domain)")
    print("=" * 60)
