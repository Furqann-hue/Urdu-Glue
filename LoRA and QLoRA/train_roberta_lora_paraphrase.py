"""
Fine-tune XLM-RoBERTa-Large model with LoRA technique on UPPC (Urdu Paraphrase Plagiarism Corpus) dataset
...
LEARNING_RATE = 2e-5
NUM_EPOCHS = 10
OUTPUT_DIR = "./roberta_lora_paraphrase"
...
def main():
    ...
    print("=" * 60)
    print("XLM-RoBERTa-Large LoRA Fine-tuning for Urdu Paraphrase Detection (UPPC Dataset)")
    print("=" * 60)
