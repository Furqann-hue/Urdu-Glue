"""
Fine-tune mBERT model with LoRA technique on Urdu NER (Named Entity Recognition) dataset
...
def main():
    ...
    print("=" * 60)
    print("mBERT LoRA Fine-tuning for Urdu NER (Named Entity Recognition)")
    print("=" * 60)
